...
class MainActivity : AppCompatActivity() { // 자식 클래스 : 부모클래스 , ()가 있다는 것은 생성잘르 호출한 것 cf)인터페이스 상속
    override fun onCreate(savedInstanceState: Bundle?) { //fun은 함수를 의미. AppCompatActivity의 onCreate를 재정의(오버라이드) 하겠다는 것.
